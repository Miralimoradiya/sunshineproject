...
<div className="planpage-top1">
        <div className="left">
          ...
          <p style={{ margin: "25px 0px 0px 0px" }}>
            ...
            Palmer’s Project <ArrowForwardIosIcon className="arrow-right" /> Sub-contractor
          </p>
        </div>
        ...
        <div className="selectaddflex">
          <div>
            <select>
              <option value="Active project">All Sub</option>
...
export default SubContractorHead
